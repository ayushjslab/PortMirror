...
export default function AuthButton() {
    ...
    if (status === "loading") {
        return (
            <button disabled className="px-4 py-2 rounded-lg bg-gray-200 animate-pulse text-transparent">
                Loading...
            </button>
        );
    }
    ...
    return (
        <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-white border border-gray-200 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all shadow-sm"
        >
